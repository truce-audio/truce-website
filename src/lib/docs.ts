...
export async function getSidebar(): Promise<SidebarSection[]> {
  ...
  const examplesOrder = [
    ...
    "examples/tremolo.md",
    "examples/state.md",
    "examples/envelope.md",
    "examples/cc-filter.md",
    "examples/chord.md",
    "examples/stereo-utility.md",
    "examples/dasp-bitcrusher.md",
    "examples/sysex-echo.md",
    "examples/multiport.md",
    "examples/midi-inspector.md",
    "examples/mpe-spreader.md",
    "examples/mpe-synth.md",
    "examples/fundsp-reverb-simple.md",
    "examples/fundsp-reverb-worker.md",
    "examples/gain-egui.md",
    "examples/gain-egui-aspect.md",
