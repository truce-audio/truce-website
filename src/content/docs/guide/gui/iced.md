...
[`examples/truce-example-gain-iced`](https://github.com/truce-audio/truce/tree/main/examples/truce-example-gain-iced) has a complete plugin with custom header, knobs,
